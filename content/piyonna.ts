  ...
  ko: {
    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          {
            p: "이 두 시스템을 기반으로 5명이 일했습니다. 프랑스 현지화 리드, 프로덕트 디자이너, 엔지니어, 그리고 가격과 카테고리를 담당한 MD 2명입니다. 정의된 역할 사이에 떨어지는 일은 제가 모두 흡수했습니다.",
          },
          { p: "플랫폼은 3개월 기간 안에 런칭했고, 현재 운영 중입니다." },
        ],
      },
    ],
    lessonLabel: "여기서 얻은 것",
    lesson: [
