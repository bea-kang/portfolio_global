...
export const piyonna: Record<Locale, PiyonnaContent> = {
  ...
  ko: {
    ...
    lessonLabel: "레슨런",
    lesson: [
      "도메인 지식 없이 주어진 3개월은 '무엇을 배우지 않을 것인가'를 결정하게 만듭니다. 인터뷰를 좁힌 것은 의도적인 선택이었습니다. 포지셔닝과 가격이 첫 런칭을 끌고 갈 것이고, 나머지는 실제 트래픽을 받은 뒤에 교정할 수 있다는 데 베팅했습니다.",
      "PM은 더 이상 기획하고 프로젝트를 관리하는 역할에 머물지 않습니다. 런칭까지 가는 길에는 누가 맡아야 할지 정해지지 않은 그레이존이 훨씬 많고, 그것을 먼저 인식해 직접 실행하는 역량이 중요해졌습니다. AI 도구가 발전하면서 한 사람이 실행할 수 있는 범위도 그만큼 넓어졌습니다. 이 프로젝트에서는 그 판단을 실제 업무에 적용해, 역할 사이에 떨어지는 일을 제가 모두 흡수했습니다.",
    ],
